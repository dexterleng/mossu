class PythonStartCheckService
  ...
  def process_base_submission
    ...
    PythonBaseSubmissionProcessingService.new(submission_zip_path: deserialized_base_submission_zip, output_dir: extracted_base_submission_dir).perform
  ...
  def upload_submissions(submission_paths, base_submission_path = nil)
    PythonMossUploadingService.new(submissions: submission_paths, base_submission: base_submission_path).perform!
  end
  ...
  def process_submission(zip, submission)
    ...
    PythonSubmissionProcessingService.new(submission_zip_path: zip, output_dir: processed_submission_path).perform
  end
